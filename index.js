...
bot.on('message', async msg=> {
    ...
    if (msg.content === "Blubadub") {
        ...
        msg.channel.send('https://c.tenor.com/hnP8FWI5fB4AAAAC/joseph-joestar-nice.gif');

    }else if(msg.content === "ruh roh"){
        msg.channel.send('https://tenor.com/x2Yc.gif');
...
bot.on("message", async message => {
    ...
    if (foundInText) {
        message.channel.send("https://c.tenor.com/mYbI09S93U8AAAAd/supa-hot-fire-ooooh.gif");
    }
    ...
    if (foundInText) {
        message.channel.send("https://tenor.com/bEhW8.gif");
    }
